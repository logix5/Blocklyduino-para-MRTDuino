...
Code.initLanguage = function() {
  ...
  var categories = ['catInOut','catSerialAll','catSerial','catSerial1','catSoftSerial','catMotorMRT','catServo','catOLED','catSerialLCD','catSerialLCD_I2C','catDisplay','catLCD','catDigital','catAnalog', 
